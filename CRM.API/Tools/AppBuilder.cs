...
using CRM.Application.Services.UserServices.User;
...
using CRM.Data.Repositories.AuthRecovery;
using CRM.Data.Repositories.AuthSundry;
using CRM.Data.Repositories.Base;
using CRM.Data.Repositories.Excel;
using CRM.Data.Repositories.Registration;
using CRM.Data.Repositories.SignIn;
using CRM.Data.Repositories.SignOut;
...
{
  /// <summary>
  ///   Provides methods to configure various services and settings for the web application.
  /// </summary>
  public class AppBuilder
  {
    ...
    /// <summary>
    ///   Configures basic services for the application.
    /// </summary>
    ...
    /// <summary>
    ///   Configures SignalR for real-time web functionality.
    /// </summary>
    ...
    /// <summary>
    ///   Configures dependency injection for various services.
    /// </summary>
