...
namespace CRM.Core.Interfaces.Infrastructure.Excel
{
  ...
  public interface IExcelFillingSheet
  {
    ...
    /// <param name="orders">The collection of orders to use for filling the worksheet.</param>
    Task Orders(IXLWorksheet sheet, List<Order> orders);
    ...
    /// <param name="orders">The collection of orders to use for filling the worksheet.</param>
    Task OrderProducts(IXLWorksheet sheet, List<Order> orders);
    ...
    /// <param name="orders">The collection of orders to use for filling the worksheet.</param>
    Task OrderAddOns(IXLWorksheet sheet, List<Order> orders);
  }
}