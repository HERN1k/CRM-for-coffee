...
namespace CRM.Core.Interfaces.Repositories.AuthRepositories.Registration
{
  /// <summary>
  ...
  public interface IRegistrationRepository
  {
    ...
    /// <returns>A task representing the asynchronous operation. The task result contains the saved <see cref="User"/>.</returns>
    /// <exception cref="ArgumentNullException">Thrown if the user is null.</exception>
    Task<User> SaveNewWorker(User user);

    /// <summary>
    ///   Gets a list of all administrators.
    /// </summary>
    /// <returns>A list of <see cref="User"/> who are administrators.</returns>
